...
class WeatherConditionManagementView extends StatefulWidget {
  const WeatherConditionManagementView({Key? key}) : super(key: key);

  @override
  _WeatherConditionManagementViewState createState() => _WeatherConditionManagementViewState();
}

class _WeatherConditionManagementViewState extends State<WeatherConditionManagementView> {
  ...
  void _confirmDelete(BuildContext context, ConditionMeteo condition) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        content: Text('Voulez-vous vraiment supprimer cette condition météo du ${DateFormat('dd/MM/yyyy').format(condition.dateReleve!)} ?'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
          ...
          ElevatedButton(
            ...
            onPressed: () {
              context.read<ConditionMeteoProvider>()
                  .supprimerCondition(condition.idMeteo!)
                  .then((_) {
                Navigator.pop(context);
                _showSuccessSnackBar('Condition météo supprimée');
              });
            },
        ...
        trailing: Row(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () => _confirmDelete(context, condition),
            ),
          ],
        ),
        children: [
