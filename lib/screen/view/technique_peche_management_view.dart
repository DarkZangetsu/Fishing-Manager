...
class TechniquePecheManagementView extends StatefulWidget {
  const TechniquePecheManagementView({Key? key}) : super(key: key);

  @override
  _TechniquePecheManagementViewState createState() => _TechniquePecheManagementViewState();
}

class _TechniquePecheManagementViewState extends State<TechniquePecheManagementView> {
  ...
  void _confirmDelete(BuildContext context, TechniquePeche technique) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        content: Text('Voulez-vous vraiment supprimer la technique ${technique.nom}?'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
          ...
          ElevatedButton(
            ...
            onPressed: () {
              context.read<TechniquePecheProvider>()
                  .supprimerTechnique(technique.idTechnique!)
                  .then((_) {
                Navigator.pop(context);
                _showSuccessSnackBar('Technique de Pêche supprimée');
              });
            },
        ...
        trailing: Row(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () => _confirmDelete(context, technique),
            ),
          ],
        ),
        children: [
