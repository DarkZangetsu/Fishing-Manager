...
class UserFishermanTechniqueView extends StatefulWidget {
  const UserFishermanTechniqueView({Key? key}) : super(key: key);

  @override
  _UserFishermanTechniqueViewState createState() => _UserFishermanTechniqueViewState();
}

class _UserFishermanTechniqueViewState extends State<UserFishermanTechniqueView> {
