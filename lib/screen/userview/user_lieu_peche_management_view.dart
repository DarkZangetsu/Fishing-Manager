...
class UserLieuPecheManagementView extends StatefulWidget {
  const UserLieuPecheManagementView({Key? key}) : super(key: key);

  @override
  _UserLieuPecheManagementViewState createState() => _UserLieuPecheManagementViewState();
}

class _UserLieuPecheManagementViewState extends State<UserLieuPecheManagementView> {
