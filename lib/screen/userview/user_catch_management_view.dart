...
class UserCaptureManagementView extends StatefulWidget {
  const UserCaptureManagementView({Key? key}) : super(key: key);

  @override
  _UserCaptureManagementViewState createState() => _UserCaptureManagementViewState();
}

class _UserCaptureManagementViewState extends State<UserCaptureManagementView> {
  // Text Controllers
