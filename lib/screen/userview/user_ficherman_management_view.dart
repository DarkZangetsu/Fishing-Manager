...
class UserFishermanManagementView extends StatefulWidget {
  const UserFishermanManagementView({Key? key}) : super(key: key);

  @override
  _UserFishermanManagementViewState createState() => _UserFishermanManagementViewState();
}

class _UserFishermanManagementViewState extends State<UserFishermanManagementView> {
